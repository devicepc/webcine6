...
function crearUsuario(){
      Nombre= prompt("Ingrese un usuario :");
    var Password = prompt("ingrese un Contraseña :");
	var ConPassword = prompt(" Repita la contraseña para confirmar");
}
...
//var FechaPeliCom2 = FechaPeliCom;
  ...
  function contarentradas(){
      if (integer >= 20){
          swal("si necesitas tantas entradas comunicate con nuestra parte de corporativos");
          document.getElementById('number').innerHTML = "20";
          deshabpdfexport1()
      } else if(integer <= 0){
          swal("El numero minimo de entradas es 0");
  ...
  function pagar(){
     ...
     // document.getElementById("precio").innerHTML = totalMensage;
      ...
      document.getElementById("NICKNAME").innerHTML = ( "Usuario : "+ Nombre);
      // ocultarInfoSalas2();
  }
